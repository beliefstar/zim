package org.zim.reactor.bootstrap;
...
public class ZimServerBootstrap {
    ...
    public DefaultZimChannelFuture bind() {
        validate();
    ...
    public DefaultZimChannelFuture bind(SocketAddress socketAddress) {
        validate();
    ...
    private DefaultZimChannelFuture doBind(SocketAddress socketAddress) {
        ZimChannel channel;
        try {
        ...
        DefaultZimChannelFuture bindFuture = new DefaultZimChannelFuture(channel);
    ...
    private void doBind0(ZimChannel channel, SocketAddress socketAddress, DefaultZimChannelFuture bindFuture) {
