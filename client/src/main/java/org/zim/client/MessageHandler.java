...
public class MessageHandler {
    ...
    public static void handleOnlineNotice(RemoteCommand command) {
        Long userId = Long.valueOf(command.getExtendField(MessageConstants.TO));
        String userName = command.getExtendField(MessageConstants.TO_NAME);
        ClientHandler.getInstance().onlineClientInfoMap.put(userName, ClientInfo.of(userId, userName));
