package org.zhenxin.zim.client;

import org.zhenxin.zim.client.command.CommandHelper;
...
public class MyClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        boolean b = sc.connect(new InetSocketAddress("127.0.0.1", Constants.SERVER_PORT));
